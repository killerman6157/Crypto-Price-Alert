...
TELEGRAM_BOT_TOKEN = os.getenv("BOT_TOKEN") if not TELEGRAM_BOT_TOKEN: raise ValueError("⚠️ BOT_TOKEN bai da kyau ko bai samu ba daga .env file. Tabbatar ka saka BOT_TOKEN=... a cikin .env")

COINGECKO_API_URL = "https://api.coingecko.com/api/v3/simple/price" price_alerts = {}
