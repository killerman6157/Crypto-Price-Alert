...
from handlers.general import start_command, help_command, send_main_menu
from handlers.price import get_price, set_alert, my_alerts_command, cancel_alert
...
if not TELEGRAM_BOT_TOKEN:
    raise ValueError("⚠️ BOT_TOKEN bai samu ba daga .env file. Tabbatar ka saka BOT_TOKEN=... a ciki")
